...
export const Projects: Record<EnumProject, Types.Project> = {
    ...
    [EnumProject.TodoLess]: {
        ...
        githubUrl: 'https://github.com/gkfat/todoless',
        websiteUrl: 'https://todoless-client.onrender.com',
        imagesUrls: [
            '/img/project/todoless/1.png',
            '/img/project/todoless/2.png',
            '/img/project/todoless/3.png',
            '/img/project/todoless/4.png',
